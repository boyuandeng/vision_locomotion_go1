...
{
public:
    Lcm_Server_Low(LeggedType rname) : udp(LOWLEVEL,UNITREE_LEGGED_SDK::UDP_CLIENT_PORT,UNITREE_LEGGED_SDK::UDP_SERVER_IP_BASIC,UNITREE_LEGGED_SDK::UDP_SERVER_PORT), mylcm(LOWLEVEL){
        udp.InitCmdData(cmd);
    }
    void UDPRecv(){
        udp.Recv();
...
{
public:
    Lcm_Server_High(LeggedType rname): udp(HIGHLEVEL,UNITREE_LEGGED_SDK::UDP_CLIENT_PORT,UNITREE_LEGGED_SDK::UDP_SERVER_IP_BASIC,UNITREE_LEGGED_SDK::UDP_SERVER_PORT), mylcm(HIGHLEVEL){
        udp.InitCmdData(cmd);
    }
    void UDPRecv(){
        udp.Recv();
